...
export const TabLink = (props: TabLinkProps) => {
  ...
  return (
    <div
      className="site-tab-link cursor-pointer"
      onClick={click}
      style={styleLogic}
    >
      {title}
...
export const TabLinksRow = (props: TabLinkRowProps) => {
  ...
  return <div className="site-tab-rows">{displayedTabs}</div>;
};

export const TabContent = (props: TabContentProps) => (
  <div className="site-tab-content site-border">{props.content}</div>
);
